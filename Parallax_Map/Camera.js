...
class CameraController {
    ...
    updateMatrix() {
        ...
        glMatrix.vec3.set(v, 0.0, 1.0, 5.0);
        let VIEWMATRIX = glMatrix.mat4.create();
        glMatrix.mat4.identity(VIEWMATRIX, VIEWMATRIX);

        glMatrix.mat4.translate(VIEWMATRIX, VIEWMATRIX, v);
        // glMatrix.mat4.invert(this.camera.vMatrix, this.camera.vMatrix);

        glMatrix.mat4.rotateY(VIEWMATRIX, VIEWMATRIX, - this.gui.view_directionX / 10.0);
        //glMatrix.mat4.translate(this.camera.vMatrix, this.camera.vMatrix, -v);
        glMatrix.mat4.translate(VIEWMATRIX, VIEWMATRIX, v);
        glMatrix.mat4.invert(this.camera.vMatrix, VIEWMATRIX);


        //glMatrix.mat4.rotateX(this.camera.vMatrix, this.camera.vMatrix, 0.0);
